...
if __name__ == "__main__":
    angles,res = bb.backbone_angles("state12/state_12.nc", "rna_no_water.prmtop", residues=['G_6_0'], angles=['chi'])
    ...
    plt.ylim(0,1.2)
    plt.annotate('anti', xy=(4.2, 0.4), xytext=(3.6, 0.6),
                arrowprops=dict(facecolor='black', shrink=0.05),
                 size=30
                )
    plt.annotate('high-anti', xy=(4.7, 0.8), xytext=(3.0, 1.0),
                arrowprops=dict(facecolor='black', shrink=0.05),
                 size=30
                )
